        ...
        <section class="content">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ route('topic.update',$topics->_id) }}" method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Topic Name English <span style="color: red">*</span></label>
                                <input type="text" class="form-control required" value="{{$topics->topic_name_lang['en_us']}}"  name="topic_name_en_us" placeholder="Enter Topic Name In English">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" value="{{$topics->topic_name_lang['hindi']}}"  name="topic_name_hindi" placeholder="Enter Topic Name In Hindi">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    @foreach($status as $key=>$value)
                                        <option value="{{$key}}" {{ ( $key == $topics->status) ? 'selected' : '' }}>{{$value}}</option>
                                    @endforeach
                                </select>
